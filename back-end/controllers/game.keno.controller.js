...
const { STATUS_GAME, STATUS_HISTORY_GAME, LOAI_CUOC_GAME, LOAI_BI } = require("../configs/game.keno");
  ...
  createDatCuoc = catchAsync(async (req, res, next) => {
    ...
    await session.withTransaction(async () => {
      try {
        ...
        listDatCuoc.forEach(({ loaiCuoc, loaiBi }) => {
          noiDungBienDongSoDu += `Cược bi ${loaiBi} - ${loaiCuoc} - ${convertMoney(tienCuoc)} | `;
        });
